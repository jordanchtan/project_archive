...
def correlation_heatmap(df, curr):
    ...
    sns.heatmap(correlations, fmt='.2f',
                square=True, annot=True, cbar_kws={"shrink": .70}, annot_kws={"fontsize": 14})
    folder = './original/vad_vad_heatmap_norm/'
    plt.savefig(folder+'vad_vad_heatmap_norm_' +
                curr + '.png', bbox_inches='tight')
